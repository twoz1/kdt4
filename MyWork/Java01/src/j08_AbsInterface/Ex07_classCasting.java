...
public class Ex07_classCasting {
	...
	public static void main(String[] args) {
		...
		//=> instanceof Test
		if(dog instanceof PetAnimal) System.out.println("**dog는 PetAnimal 입니다.**");
		if(dog instanceof Mammal) System.out.println("**dog는 Mammal 입니다.**");
		if(dog instanceof Animal2) System.out.println("**dog는 Animal2 입니다.**");

		// Test2. class Up_Casting TEST
		Animal2 an1 = new PetAnimal(); // 조상 <- 후손 : Up_Casting, 자동
		//an1 = new Reptile(); // 모든 후손은 교체가능(다형성 적용)

		//PetAnimal pa = new Animal2(); // 후손 <- 조상 : Down_Casting, 안 돼요!
